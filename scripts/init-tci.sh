...
echo GITHUB_PRIVATE_KEY_FILE_PATH=$GITHUB_PRIVATE_KEY_FILE_PATH >> temp/tci.config
...
echo TCI_SERVER_TITLE_COLOR=$TCI_SERVER_TITLE_COLOR  >> temp/tci.config
...
echo TCI_BANNER_COLOR=$TCI_BANNER_COLOR  >> temp/tci.config
...
echo JENKINS_HTTP_PORT_FOR_SLAVES=$JENKINS_HTTP_PORT_FOR_SLAVES  >> temp/tci.config
...
echo JENKINS_SLAVE_AGENT_PORT=$JENKINS_SLAVE_AGENT_PORT  >> temp/tci.config
...
#    TCI_HOST_IP="$REPLY"
#fi
#echo TCI_HOST_IP=$TCI_HOST_IP  >> temp/tci.config
